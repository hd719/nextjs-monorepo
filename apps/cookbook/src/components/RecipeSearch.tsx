  ...
  return (
    <div className={classNames("relative", className)}>
      ...
      {showResults && hasQuery && (
        <div
          className={classNames(
            "absolute -bottom-1 left-0 z-50 grid max-h-[200px] w-full translate-y-full grid-cols-1 gap-px overflow-hidden overflow-y-auto rounded-lg border border-[#EBEBEB] bg-[#EBEBEB] transition-all duration-300 ease-in-out",
            {
