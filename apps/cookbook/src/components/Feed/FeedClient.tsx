      ...
      <div className="container">
        <div className="mb-8 grid grid-cols-2 gap-x-5 gap-y-8 lg:mb-16 lg:grid-cols-3 xl:gap-x-12 xl:gap-y-16">
          {currentRecipes.map((recipe: Recipe, index: number) => (
            <div
              key={recipe.id}
              className="group h-fit max-w-[370px] flex-1 rounded-lg border border-appGray-300 bg-appGray-100/50 bg-clip-padding p-6 backdrop-blur-lg backdrop-filter transition-transform duration-300 hover:scale-105 hover:shadow-lg hover:shadow-appAccent/10"
