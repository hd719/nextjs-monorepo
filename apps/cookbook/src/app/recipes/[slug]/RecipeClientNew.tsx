          ...
          <div className="mb-12 grid gap-8 lg:grid-cols-2">
            ...
            <div className="card p-8">
              ...
              <div className="mb-6 grid grid-cols-2 gap-4">
                ...
                {recipe.servings && (
                  <div className="border-accent-200 from-accent-50 to-accent-100 rounded-xl border bg-gradient-to-br p-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-accent-900 text-lg font-bold">
                          {recipe.servings}
                        </p>
                      </div>
                    </div>
              ...
              <div className="card p-8">
                ...
                <ul className="space-y-3">
                  {recipe.ingredients.map((ingredient, index) => (
                    <li
                      key={index}
                      className="border-secondary-200 from-secondary-50 to-secondary-100 group flex items-start gap-4 rounded-xl border bg-gradient-to-r p-4 transition-all duration-200 hover:shadow-md"
                    >
                      <div className="mt-1 flex-shrink-0">
                        <div className="bg-gradient-secondary flex h-6 w-6 items-center justify-center rounded-full">
              ...
              <div className="card p-8">
                ...
                <ol className="space-y-4">
                  {recipe.steps.map((step, index) => (
                    <li
                      key={index}
                      className="border-accent-200 from-accent-50 to-accent-100 group flex gap-5 rounded-xl border bg-gradient-to-r p-5 transition-all duration-200 hover:shadow-md"
                    >
